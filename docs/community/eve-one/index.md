...
title: eveo.cc
type: service
description: All-in-one portal for capsuleers away from the pod
maintainer:  # `IIBankII` is required, and exactly one of `github`, `gitlab`, or 'repository' is required
  name: IIBankII
  github: VSKoen # GitHub username, this will generate a link to your GitHub profile
---
...
A full in-browser fitting tool built around EVE's actual slot system.

- High, Med, Low, Rig, and Subsystem slots (including T3 cruisers — Tengu, Loki, Legion, Proteus)
- Live dogma stat engine — CPU, Power Grid, Capacitor, Shield/Armor/Hull HP, resistances, speed, and signature radius update in real time as you fit modules
- Hardware Browser — searchable module database with category trees
- Ship Catalog — any ship in New Eden as your base hull
- Drone Bay Panel — dedicated drone management
- EFT import and export
- Save fits directly to ESI
- Saved Fits Browser — load any of your ESI fits into the simulator instantly
- Charge compatibility and module validation
...
Link unlimited EVE characters via EVE SSO. All your alts sit in the sidebar — one click switches your active pilot and every panel updates accordingly. Characters persist between sessions with automatic token refresh.

---

## Login & Security

EVE ONE uses EVE SSO with PKCE. Your credentials never touch EVE ONE's servers — login goes through CCP's own SSO, and your character data comes directly from ESI to you.
...
*Built under the EVE Online third-party developer license.*
